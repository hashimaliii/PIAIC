...
function isNotInArray(array: number[], item: number): boolean {
...
const test11: boolean = "hello".toLowerCase() === "Hello";
const test12: boolean = "hello".toLowerCase() === "Hello" && (2 * 3) > 5;
const test13: boolean = isNotInArray(myArray, 6)
const test14: boolean = isNotInArray(myArray, 4)
